...
ActiveRecord::Schema[7.1].define(version: 2024_12_10_143822) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.index ["countries_id"], name: "index_bookings_on_countries_id"
  ...
  add_foreign_key "bookings", "countries", column: "countries_id"
